...
def _probe_gemini():
    """
    Try one embed call to verify Gemini is reachable. Returns model or Node
    """
    try:
...
def _load_fallback():
    ...
    logfire.info("Loading sentence-transformers falback (all-mpnet-base-v2, 768-dim)...")
...
def embed_batch(batch: list[str]) -> list[list[float]]:
    """Embed a list of documents. Use batched embedding for better performance."""
